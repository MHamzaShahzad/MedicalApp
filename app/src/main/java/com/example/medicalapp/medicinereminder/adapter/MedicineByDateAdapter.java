...
public class MedicineByDateAdapter extends RecyclerView.Adapter<MedicineByDateAdapter.ViewHolder> {
    Context mContext;
    ...
    public MedicineByDateAdapter(Context mContext, ArrayList<MedicinePerRow> medicinePerRows, ArrayList<Medicine> medicine) {
