...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.ViewHolder> {
    ...
    public MyRecyclerViewAdapter(Context context, ArrayList<String> MedicineName, String NAME) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        holder.medicineName.setText(MedicineName.get(position).toString());
        if (MedicineName.contains(NAME)) {
